...
const casas: Casas[] = [
    ...
    {
        casa: "Marvel Comics",
        data: ["Antman", "Thor", "Spiderman", "IronMan", "Antman", "Thor", "Spiderman", "IronMan", "Antman", "Thor", "Spiderman", "IronMan", "Antman", "Thor", "Spiderman", "IronMan", "Antman", "Thor", "Spiderman", "IronMan", "Antman", "Thor", "Spiderman", "IronMan"]
    },
    {
        casa: "Anime",
